...
function buttonVariants({
  ...
  return cn(BUTTON_BASE, BUTTON_VARIANT_CLASSES[variant], BUTTON_SIZE_CLASSES[size], className);
}
...
function Button({
  ...
  if (asChild) {
    return renderAsChild(children as React.ReactElement, sharedProps);
  }
